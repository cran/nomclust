...
#' 
#' @description The function calculates a dissimilarity matrix based on the IOF similarity measure.
#' \cr               
#'  
...
iof <- function(data, var.weights = NULL) {
  ...
  prox_matrix <- SIMILARITY(data, measure = "iof", freq.table, wt = var.weights)

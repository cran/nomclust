...
#' weights.good4 <- good4(data20, var.weights = c(0.7, 1, 0.9, 0.5, 0))
#' 
#' @export

good4 <- function(data, var.weights = NULL) {
  ...
  prox_matrix <- SIMILARITY(data, measure = "good4", freq.table, wt = var.weights)

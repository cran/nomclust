...
#' 
#' @description The function calculates a dissimilarity matrix based on the G2 similarity measure.
#' 
...
goodall2 <- function(data, var.weights = NULL) {
  ...
  prox_matrix <- SIMILARITY(data, measure = "goodall2", freq.table, wt = var.weights)

...
#' weights.good1 <- good1(data20, var.weights = c(0.7, 1, 0.9, 0.5, 0))
#' 
#' @export 

good1 <- function(data, var.weights = NULL) {
  ...
  prox_matrix <- SIMILARITY(data, measure = "good1", freq.table, wt = var.weights)

...
#' 
#' @description The function calculates a dissimilarity matrix based on the G1 similarity measure.
#' 
#'  
#' @param data A data.frame or a matrix with cases in rows and variables in column.
#' 
...
goodall1 <- function(data, var.weights = NULL) {
  ...
  prox_matrix <- SIMILARITY(data, measure = "goodall1", freq.table, wt = var.weights)
